...
var common_ops = {
    ...
    setMenuIconHighLight:function(){
        ...
        if(  pathname.indexOf("/qualification") > -1  ){
            nav_name = "qualification";
        }
        ...
        if(  pathname.indexOf("/infomation") > -1  ){
            nav_name = "infomation";
        }
        if(  pathname.indexOf("/suffix") > -1  ){
            nav_name = "suffix";
        }
        if(  pathname.indexOf("/competitionjob") > -1  ){
            nav_name = "competitionjob";
        }
        if( nav_name == null ){
            return;
        }
