...
def create_art_image(content_image, style_image, output_image, model_path='models/21styles.model', cuda=False, content_size=512, style_size=512):
    content_image = tensor_load_rgbimage(content_image, size=content_size, keep_asp=True)
    content_image = content_image.unsqueeze(0)
    style = tensor_load_rgbimage(style_image, size=style_size)
    ...
    tensor_save_bgrimage(output[0].detach(), output_image, cuda)

# sample
# create_art_image('web/static/uploads/20200512150433.jpg', 'web/static/styles/candy.jpg', 'web/static/output-1.jpg', model_path='models/21styles.model')
# create_art_image('images/content/venice-boat.jpg', 'images/21styles/feathers.jpg', 'output-2.jpg')
